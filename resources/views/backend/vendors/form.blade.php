<div class="form-group">
    ...
    {{ Form::text('vendor_name', old('vendor_name'), [ 'class' => 'form-control',
     'aria-describedby' => 'titleHelp',  'placeholder' => 'Vendor Name','required' =>'required']) }}
</div>
        ...
        <div class="pull-right">
            ...
            @if(isset($vendor))
                ...
                <div class="col-md-4" style="float:right;">
                    <a href="" class="btn btn-danger button pull-right"  data-id="{{ $vendor->id }}">
