...
{{ Form::label('bank', 'bank', ['class' => 'control-label']) }}
     {{ Form::select('bank',['' => '---- Select a bank ----', 'FSIB' => 'FSIB', 'DBBL' => 'DBBL', 'Bank_Asia' => 'Bank_Asia', 'Trust_Bank' => 'Trust_Bank', 'Sonali_Bank' => 'Sonali_Bank', 'Janata_Bank' => 'Janata_Bank', 'Prime_Bank' => 'Prime_Bank'] , old('bank'),
            ['class' =>'form-control']) }}
...
{{ Form::label('payment_method', 'payment_method', ['class' => 'control-label']) }}
     {{ Form::select('payment_method',['' => '---- Select a bank ----', 'cash' => 'cash', 'bank' => 'bank', 'mobile-wallet' => 'mobile-wallet'] , old('payment_method'),
            ['class' =>'form-control']) }}
